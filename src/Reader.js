...
(function (global, undefined) {
    ...
    Object.defineProperties(Reader.prototype, {
        ...
        readMapWithoutTag: { value: function() {
            return readMapWithoutTag(this);
        } },
        readMap: { value: function() {
            return readMap(this);
        } },
        readHarmonyMapWithoutTag: { value: function() {
            return readHarmonyMapWithoutTag(this);
        } },
        readHarmonyMap: { value: function() {
            return readHarmonyMap(this);
        } },
